...
namespace JumpGate\Database\Searching\Providers;
...
{
    /**
     * @var \Illuminate\Database\Eloquent\Model|\JumpGate\Database\Searching\Contracts\Searchable
     */
    public $model;

    /**
     * @var \Illuminate\Database\Eloquent\Model|\JumpGate\Database\Searching\Contracts\Searchable||\Illuminate\Database\Eloquent\Collection
     */
    public $search;
